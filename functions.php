...
function scriptInit()
{
    ...
    wp_enqueue_script('js-main', get_template_directory_uri() . '/js/main.js', array('jquery'), '0.1.0');               // Add theme javascript file ( THEME_DIR/js/main.js )
    wp_enqueue_style('css-init', get_template_directory_uri() . '/css/init.css', array(), '0.1.0');                     // Add theme css file        ( THEME_DIR/css/init.css )
    wp_enqueue_style('css-default', get_template_directory_uri() . '/css/default.css', array('css-init'), '0.1.0');     // Add theme css file        ( THEME_DIR/css/default.css )
}
